    ...
    <div class="grid sticky-mobile-checkout__grid">
        <div class="grid__col sticky-mobile-checkout__col sticky-mobile-checkout__col--left">
            <div class="sticky-mobile-checkout__inner">
                <span class="label-text sticky-mobile-checkout__label"><?php esc_html_e('Total', 'twmp-phonghoa'); ?>:</span>
        ...
        <div class="grid__col sticky-mobile-checkout__col sticky-mobile-checkout__col--right">
            ...
            get_template_part('templates/core-blocks/button', null, [
                'class'       => 'sticky-mobile-checkout__button w-100',
                'button_text' => esc_html__('Place order', 'twmp-phonghoa'),
                'button_url' => '#',
                'type' => 'primary',
                'button_attrs' => ' data-checkout-page-trigger',
            ]);
            ?>
        </div>
    </div>
